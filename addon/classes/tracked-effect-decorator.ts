...
export default function effect(
  ...
  assert(
    `You can only use the @effect decorator on the ${target.constructor.name} class on a property and not on a method. Rewrite '@effect ${propertyKey}() {}' as '@effect ${propertyKey} = () => {};'`,
    oldInit
  );
